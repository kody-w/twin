# specs/ — bundled contracts for Kody Wildfeuer
...
This directory was bundled on **2026-05-09T12:51:46Z** from `kody-w/RAPP @ fb784f9 (post-Bond-Pulse)`. The contracts here are FROZEN at planting time — they do not change unless an operator runs a `specs refresh` action.
...
- **Lifted at:** 2026-05-09T12:51:46Z
...
```bash
# (future) brainstem run specs-refresh --neighborhood kody-w/twin
```
